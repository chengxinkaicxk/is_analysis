...
### 3.7 超期罚款
  ...
  |其它事件流|第3步，系统读入图书信息错误时，提示图书信息错误；   第3步，系统读入图书信息后检测到图书未被借阅时，显示该图书不能进行还书操作；  第6步，系统检测到读者卡内金额不足以进行罚款扣费时，提示卡内余额不足；|  
  |异常事件流|第8步，超期罚款操作时出现系统故障，例如网络故障，数据库服务器故障，系统弹出系统异常页面，提示扣费失败  第8步，还书操作时出现系统故障，例如网络故障，数据库服务器故障，系统弹出系统异常页面，提示还书失败 | 
  |备注|无|
